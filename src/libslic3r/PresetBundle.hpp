...
public:
    ...
    PresetsConfigSubstitutions load_user_presets(AppConfig &config, std::map<std::string, std::map<std::string, std::string>>& my_presets,
                                                ForwardCompatibilitySubstitutionRule rule, const std::set<std::string>* cloud_names = nullptr);
    ...
    void remove_users_preset(AppConfig &config, std::map<std::string, std::map<std::string, std::string>> * my_presets = nullptr,
                             const std::set<std::string>* cloud_names = nullptr);
